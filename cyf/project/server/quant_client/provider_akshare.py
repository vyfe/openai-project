...
from quant_client.common import compact_date_text, normalize_symbol, parse_trade_date, resolve_market_info, to_float
...
logger = logging.getLogger("quant.client.akshare")
    ...
    def fetch_daily_bars(self, symbols: list[str], start_date: str, end_date: str, adjust_flag: str = "qfq") -> list[dict]:
        ...
        for raw_symbol in symbols:
            ...
            try:
                ...
                logger.warning(
                    "akshare_symbol_failed symbol=%s err=%s", raw_symbol, exc,
                )
                continue
        return rows
