    ...
    <div class="chat-toolbar">
      ...
      <div v-if="!isMobile" class="toolbar-desktop">
        ...
        <div class="dialog-title-editor">
          <el-input v-model="dialogTitle" placeholder="请输入对话标题..." size="small" @blur="handleTitleBlur" />
          <!-- 更新标题按钮：当有当前对话ID时显示 -->
          <el-button v-if="currentDialogId" type="primary" size="small" @click="updateDialogTitle"
            class="update-title-btn" :disabled="!dialogTitle.trim()">
            更新标题
          </el-button>
        </div>
      ...
      <!-- 移动端抽屉菜单 -->
      <el-drawer v-if="isMobile" v-model="showToolbarDrawer" title="工具栏" direction="rtl" size="80%"
        :destroy-on-close="true" :close-on-click-modal="true">
        <div class="mobile-toolbar-content">
          <!-- 对话标题编辑区域 -->
          <div class="dialog-title-editor">
            <span class="mobile-form-label">对话标题</span>
            <el-input v-model="dialogTitle" placeholder="请输入对话标题..." size="default" @blur="handleTitleBlur" />
            <!-- 更新标题按钮：当有当前对话ID时显示 -->
            <el-button v-if="currentDialogId" type="primary" size="default" @click="updateDialogTitle"
              class="update-title-btn-mobile" :disabled="!dialogTitle.trim()">
              更新标题
            </el-button>
          </div>
    ...
    <div class="input-area">
      <div class="input-container">
        ...
        <div class="input-actions">
          ...
          <el-button type="primary" :icon="Position" :disabled="!inputMessage.trim() || isLoading" @click="sendMessage">
            发送
          </el-button>
        </div>
      </div>
